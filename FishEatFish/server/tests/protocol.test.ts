...
import { parseClientMessage, parseInput, parseSkill } from '../src/protocol/message-schemas.js';
...
test('protocol accepts whale swallow and rejects unsupported skills', () => {
